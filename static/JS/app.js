...
var couleur = d3.scaleOrdinal(["#B89E09","#FF7824"," #7315E6","#18F2BB","#7D2A19","#151D5C","#F6CD36","#6226E3","#B5B74E","#993487"]); 
...
const render = data =>{
 ...
 var tick= g.append('g').call(d3.axisLeft(yScale))
  ...
  var grect=g.selectAll("rect")
    ...
    grect.append("text")
            .attr("class", "label")
            .attr("y", d=>yScale(d.lieu)+margin.bottom)
            .text(function(data) { return data.lieu;})
            .attr("fill","white");
